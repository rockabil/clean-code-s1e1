...
const addButton = document.querySelector(".todo-form__button");//first button
...
//select ListItems children
    ...
    const editButton = taskListItem.querySelector(".todo-item__button--edit");
    const deleteButton = taskListItem.querySelector(".todo-item__button--delete");
